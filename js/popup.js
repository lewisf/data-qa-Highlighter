...
function qame() {
  ...
  qameBtn.innerHTML = "id showed!!";
  setTimeout(function() {
    qameBtn.innerHTML = "HIGHLIGHT id";
  }, 1000);
  ...
  // Number of id elements found in the DOM
...
function unqame() {
  ...
  unQameBtn.innerHTML = "id removed!!";
  setTimeout(function() {
    unQameBtn.innerHTML = "REMOVE id";
  }, 1000);
  //Current tab functions
  browser.tabs.executeScript(null, {
  ...
  found.innerHTML = "Highlighted id removed !!";
}
